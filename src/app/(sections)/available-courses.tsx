  ...
  return (
    ...
    >
      ...
      <div className="flex 2xl:max-w-[1400px] w-[90%] flex-col h-full my-[60px] max-md:w-[95%]">
        ...
        <div className="grid grid-cols-3 gap-[5%] mt-[30px] max-xl:gap-[10px] max-lg:gap-[30px] max-lg:grid-cols-2 max-lg:mb-10 max-lg:h-auto max-sm:grid-cols-1 max-sm:gap-[10px] max-xs:gap-[5px]">
